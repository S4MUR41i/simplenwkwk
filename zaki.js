...
//fake reply gc
 const reply = (teks) => {
zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Asrori Amin`,"body": `${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/zaki.jpg`),"sourceUrl": `${link}`}}}, { quoted: m})
}
//FAKE QUOTED
const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@g.us"},"message": {"groupInviteMessage": {"groupJid": "6287772549185-1622678501@g.us","inviteCode": "https://chat.whatsapp.com/JK8R3UJVF1KKySPeisEWdS","groupName": "Group Official", "caption": `${footer}`, 'jpegThumbnail': ('./media/zaki.jpg')}}}
...
break
         ...
         case'antitag': {
             ...
             if (!m.isGroup) return
             if (m.key.fromMe) return
       sendNye = fs.readFileSync('./media/f.mp3')
       zaki.sendReadReceipt(m.chat, m.sender, [m.key.id])
     zaki.sendMessage(from, {sticker:sendNye, contextInfo:{forwardingScore: 800, isForwarded: true}}, {quoted:m})
     }
     break
        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`6288227248988@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    }
                    break 
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'amin': case 'doge':{
                anu = `Hi ${pushname} 🤚`
...
`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: txt.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `${footer1}`, hydratedButtons: [{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/JK8R3UJVF1KKySPeisEWdS'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }, { quickReplyButton: { displayText: 'List Menu', id: 'allmenu', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
break
case 'command': case 'allmenu': case 'listmenu': {
var butonnya =
[{ urlButton: { displayText: 'Instagram', url: 'https://instagram.com/saya_asroriamin'} }, 
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: `${ccomannya}`, locationMessage: { jpegThumbnail: fs.readFileSync('./media/allmenu.jpg') }, hydratedFooterText: `${footer}`, hydratedButtons: [{ urlButton: { displayText: 'Instagram', url: 'https://instagram.com/saya_asroriamin'} }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
